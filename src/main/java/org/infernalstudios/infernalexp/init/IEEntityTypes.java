...
public class IEEntityTypes {
    ...
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES = DeferredRegister.create(BuiltInRegistries.ENTITY_TYPE, InfernalExpansion.MOD_ID);

    // Entity Types

    public static final Supplier<EntityType<VolineEntity>> VOLINE = ENTITY_TYPES.register("voline",
    ...
    public static final Supplier<EntityType<ShroomloinEntity>> SHROOMLOIN = ENTITY_TYPES.register("shroomloin",
    ...
    public static final Supplier<EntityType<WarpbeetleEntity>> WARPBEETLE = ENTITY_TYPES.register("warpbeetle",
    ...
    /*
    public static final Supplier<EntityType<CerobeetleEntity>> CEROBEETLE = ENTITY_TYPES.register("cerobeetle",
    ...
    public static final Supplier<EntityType<EmbodyEntity>> EMBODY = ENTITY_TYPES.register("embody",
    ...
    public static final Supplier<EntityType<BasaltGiantEntity>> BASALT_GIANT = ENTITY_TYPES.register("basalt_giant",
    ...
    public static final Supplier<EntityType<BlackstoneDwarfEntity>> BLACKSTONE_DWARF = ENTITY_TYPES.register("blackstone_dwarf",
    ...
    public static final Supplier<EntityType<GlowsquitoEntity>> GLOWSQUITO = ENTITY_TYPES.register("glowsquito",
    ...
    /*
    public static final Supplier<EntityType<PyrnoEntity>> PYRNO = ENTITY_TYPES.register("pyrno",
    ...
    public static final Supplier<EntityType<BlindsightEntity>> BLINDSIGHT = ENTITY_TYPES.register("blindsight",
    ...
    public static final Supplier<EntityType<GlowsilkMothEntity>> GLOWSILK_MOTH = ENTITY_TYPES.register("glowsilk_moth",
    ...
    public static final Supplier<EntityType<AscusBombEntity>> ASCUS_BOMB = ENTITY_TYPES.register("ascus_bomb",
    ...
    public static final Supplier<EntityType<ThrowableMagmaCreamEntity>> THROWABLE_MAGMA_CREAM = ENTITY_TYPES.register("throwable_magma_cream",
    ...
    public static final Supplier<EntityType<ThrowableFireChargeEntity>> THROWABLE_FIRE_CHARGE = ENTITY_TYPES.register("throwable_fire_charge",
	...
	public static final Supplier<EntityType<InfernalPaintingEntity>> INFERNAL_PAINTING = ENTITY_TYPES.register("infernal_painting",
    ...
    public static final Supplier<EntityType<ThrowableBrickEntity>> THROWABLE_BRICK = ENTITY_TYPES.register("throwable_brick",
    ...
    public static final Supplier<EntityType<ThrowableNetherBrickEntity>> THROWABLE_NETHER_BRICK = ENTITY_TYPES.register("throwable_nether_brick",
